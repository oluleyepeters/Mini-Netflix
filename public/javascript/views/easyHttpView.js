...
const displayResult = (posts) =>{
	let allMovies = '';
	if(posts === undefined){
		allMovies = `<div class="col-lg-6 col-md-8 col-sm-12 mb-2 mt-3 justify-content-start">
						<h5 class="mx-auto text-center wrap movieTitle">No Movie Matches Your Search Try Again</h5>
